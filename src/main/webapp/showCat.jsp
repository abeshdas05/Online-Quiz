...
<table style="border-collapse: collapse; width: 50%; text-align: center; margin-left:350px">
   ...
   <tr>
      <td style="padding: 10px;"><a href="quiz.jsp?database=<%=database%>"><%= database %> </a></td>
      <td style="padding: 10px;"><a href="EditDB.jsp?database=<%=database%>">Edit</a></td>
      <td style="padding: 10px;"><a href="deleteCatcontroller.jsp?database=<%=database%>">Delete</a></td>
   </tr>
   <% } %>
</table>
