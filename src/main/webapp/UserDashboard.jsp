...
<table style="width: 50%; border-collapse: collapse; margin-left:25%">
    <tr>
        <th style="padding: 10px; background-color: #f2f2f2;border-right: 1px solid #ddd;">Category</th>
    ...
    <tr>
        ...
        <td style="padding: 10px; border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;"><a href="userQuestion.jsp?database=<%= database %>">Take Test</a></td>
    </tr>
    <% } %>
</table>
