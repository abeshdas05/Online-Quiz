...
<table style="border-collapse: collapse; width: 100%; text-align: center;">
   ...
   <tr>
      ...
      <td style="padding: 10px;"><a href="EditQuiz.jsp?database=<%= databaseName %>&quizid=<%= quizId %>">Edit</a></td>
      <td style="padding: 10px;"><a href="deleteQuizController.jsp?database=<%= databaseName %>&quizid=<%= quizId %>">Delete</a></td>
   </tr>
   <% } %>
</table>
